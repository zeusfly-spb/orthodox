...
<template>
  <div class="login-wrapper">
    <div class="header">
      <div class="header-title">Войти в систему</div>
      <div class="header-description">Введите свою электронную почту и пароль.</div>
    </div>
    <div class="inputs">
      <Dropdown :list="pilgrimServiceList" @update="selectService" />
    ...
    <div class="enter">
      ...
      <div class="enter__description">
        У вас нет аккаунта?
        <router-link :to="{ name: 'register' }" class="forget">Регистрация</router-link>
      </div>
    </div>
  </div>
  <Alert
