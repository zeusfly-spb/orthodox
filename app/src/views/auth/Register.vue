...
<template>
  <div class="register-wrapper">
    ...
    />
    <div class="inputs">
      <regDropdown :list="pilgrimServiceList" @update="form.tour_operator_id = $event" />
      ...
      />
      <div class="limit">Минимум 8 символов</div>
      <regInput
        id="password-retry"
        inputType="password"
        firstIconPath="/svg/lock.svg"
      ...
      <div class="agreenment">
        ...
        <label for="checkbox"
          ...
          <router-link to="/" class="conditions">Условиями</router-link></label
        >
      </div>
    </div>
    <div class="enter">
