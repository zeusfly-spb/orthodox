...
const dropdownList = [{title: 'Редактировать', link: 'edit'}, {title: 'Скрыть', link: 'hide'}, {title: 'Удалить', link: 'delete'}]
                            ...
                            <button class="profile-edit-btn">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path
                                        ...
                                        stroke="#6A6E75" stroke-width="1.5" />
                                </svg>
                            </button>
                            <div class="profile-actions">
                                <button class="profile-more-btn" @click="isOpenedDropdownList = !isOpenedDropdownList">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                ...
                                <div class="profile-dropdown actions-dropdown" v-show="isOpenedDropdownList">
                                    <router-link :to="item.link" class="dropdown-item" v-for='item in dropdownList'>{{ item.title }}</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
