...
const operator = ref('');
const actionProfileList = ref([
  'Создать профиль',
  'Данные о паломнической службе',
  'Реквизиты',
  'FAQ',
  'Туры паломнической службы',
]);
...
<template>
      ...
      <div class="white-bg">
        ...
        <div class="bg-bread-proc">
          ...
          <div class="breadcrumbs">
            <span v-for="(item, i) in actionProfileList" :class="['breadcrumb-item']">
              {{ `${i + 1}. ${item}` }}
  ...
  <UModal v-show="isShowModal" @close="closeModal">
    <template #headerTitle> Редактирование </template>
    ...
    <template #bodyContent>
      ...
      <section class="requisites">
        ...
        <div class="requisites__block">
          ...
          <UInput
            id="requisites"
            v-model="modalFields.legal_name"
            :inputHeightPx="26"
            placeholder=""
          />
        </div>
          ...
          <div class="flex">
            <Popover>
              ...
              <PopoverContent class="w-auto p-0">
                <AppDatePicker
                  v-if="isCalendarOpen"
                  v-model="modalFields.ogrn_date"
                  @addDate="isCalendarOpen = false"
                />
              </PopoverContent>
            </Popover>
            <Button
      ...
      <section class="addresses">
        ...
        <div class="addresses__block">
          ...
          <UInput
            id="jur-address"
            v-model="modalFields.legal_address"
            :inputHeightPx="26"
            placeholder=""
          />
        </div>
        <div class="addresses__block">
          ...
          <UInput
            id="fac-address"
            v-model="modalFields.real_address"
            :inputHeightPx="26"
            placeholder=""
          />
        </div>
        <div class="addresses__block">
          ...
          <UInput
            id="mail-address"
            v-model="modalFields.postal_address"
            :inputHeightPx="26"
            placeholder=""
          />
        </div>
