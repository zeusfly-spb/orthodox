...
<template>
  <div class="users-section">
      ...
      <div class="users-toolbar">
        ...
        <div class="view-controls">
          <div class="sort-dropdown2">
            <span @click="isSortTypeListOpened = !isSortTypeListOpened"
              >Сортировать по: {{ sortType }}</span
            >
            <svg
              @click="isSortTypeListOpened = !isSortTypeListOpened"
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
          ...
          <div class="view-toggle">
            <button
              :class="['view-btn', { active: viewSelected === 'table' }]"
              data-view="table"
              @click="viewSelected = 'table'"
            >
              <svg
                width="20"
                height="20"
              ...
              >
                <path
                  ...
                  :stroke="viewSelected === 'table' ? '#10B981' : '#6A6E75'"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
            ...
            <button
              :class="['view-btn', { active: viewSelected === 'blocks' }]"
              data-view="blocks"
              @click="viewSelected = 'blocks'"
            >
              <svg
                width="20"
                height="20"
              ...
              >
                <rect
                  ...
                  height="6"
                  rx="1"
                  :stroke="viewSelected === 'blocks' ? '#10B981' : '#6A6E75'"
                  stroke-width="1.5"
                />
                <rect
                  x="11"
    ...
    <UModal v-show="isModalOpen" @close="closeModal">
      <template #headerTitle> Добавление пользователя </template>
